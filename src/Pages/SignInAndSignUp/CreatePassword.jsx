...
const CreatePassword = () => {
    ...
    const accountType = state && state.status;
                        ...
                        <div className="flex flex-col gap-[40px] mt-[5%]">
                            <div className="flex flex-row lg:justify-start md:justify-center">
                                <div className="flex flex-row lg:w-[218px] md:w-[218px] gap-1 sm:w-[100%] xs:w-[100%]  lg:right-[34.24%] lg:left-[50.63%] md:left-[42.43%] md:right-[42.43%] sm:left-[5%] sm:right-[5%] xs:left-[5%] xs:right-[5%] h-1.5">
                                    ...
                                    <div className="w-[32.11%] top-[0px] right-[0%] left-[67.89%] rounded-tl-none rounded-tr-3xs rounded-br-3xs rounded-bl-none bg-[#228276] h-1.5" />
                                </div>
                            </div>

                        </div>
                        <CreatePasswordForm accountType={accountType} />
                        {/* <div
                            className="[border:none] p-0 bg-[transparent] text-sm text-left inline-block  gap-2 "
                        >
