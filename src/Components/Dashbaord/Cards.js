  ...
  return (
    <div className="bg-slate-100 rounded-lg my-3 p-4 space-y-5 ">
      ...
      <div className="flex text-sm space-x-3 items-center">
        <p className="rounded-full bg-blue-600 p-4 text-xs  text-white"></p>
        <p className="font-semibold pr-9 block">
          Interview scheduled with
          <span className="text-blue-600 px-1">
            {props.name ? props.name : ".Net Developer"}
          </span>
        </p>
      ...
      <div className="flex items-center space-x-3">
        <button className="bg-blue-600 rounded-lg px-3 py-2 text-xs text-white">
          Join
        </button>
        <button className="bg-slate-50 rounded-lg px-3 py-2 text-xs text-gray-500 border-[0.5px] border-gray-500">
          Send Message
        </button>
        <button className="bg-slate-50 rounded-lg px-3 py-2 text-xs text-gray-500 border-[0.5px] border-gray-500">
          Reschedule
